...
var ____Class0=React.Component;for(var ____Class0____Key in ____Class0){if(____Class0.hasOwnProperty(____Class0____Key)){AppPage[____Class0____Key]=____Class0[____Class0____Key];}}var ____SuperProtoOf____Class0=____Class0===null?null:____Class0.prototype;AppPage.prototype=Object.create(____SuperProtoOf____Class0);AppPage.prototype.constructor=AppPage;AppPage.__superConstructor__=____Class0;
	...
	Object.defineProperty(AppPage.prototype,"endGame",{writable:true,configurable:true,value:function( ) {"use strict";
		this.setState(this.actions.endGame());
	}});


	Object.defineProperty(AppPage.prototype,"next",{writable:true,configurable:true,value:function( ) {"use strict";
		...
		return (
			React.createElement("div", {className: "game"}, 
				React.createElement("table", {className: "map"}, 
					React.createElement("tbody", null, 
						rows.map(function(rowIndex)  
							{return React.createElement("tr", {key: rowIndex, id: "row-"+rowIndex}, 
								cols.map(function(colIndex)  
									{return React.createElement(Cell, {key: ("" + rowIndex + "-" + colIndex), row: rowIndex, col: colIndex, cell: self.props.game.cells[("" + rowIndex + "-" + colIndex)], onSelect: self.props.actionSelectCell});}
								)
							);}
						)
					)
				...
				React.createElement("div", {className: "dashboard"}, 
					React.createElement("div", null, "Tour : ", self.props.game.turn), 
					React.createElement("div", null, "Le joueur ", React.createElement("span", {style: {color:self.props.game.currentPlayer}}, self.props.game.players[self.props.game.currentPlayer].name), " joue"), 
					React.createElement("div", null, 
						React.createElement("button", {onClick: self.props.actionNext}, "Fin de tour")
					), 
					React.createElement("div", null, self.props.game.selectedCell ? 'Sélection : '+self.props.game.selectedCell : null), 
					React.createElement("div", null, 
						React.createElement("button", {onClick: self.props.actionEndGame}, "Quitter")
					)
				)
			)
		);
...
var ____Class3=React.Component;for(var ____Class3____Key in ____Class3){if(____Class3.hasOwnProperty(____Class3____Key)){Cell[____Class3____Key]=____Class3[____Class3____Key];}}var ____SuperProtoOf____Class3=____Class3===null?null:____Class3.prototype;Cell.prototype=Object.create(____SuperProtoOf____Class3);Cell.prototype.constructor=Cell;Cell.__superConstructor__=____Class3;function Cell(){"use strict";if(____Class3!==null){____Class3.apply(this,arguments);}}
	Object.defineProperty(Cell.prototype,"render",{writable:true,configurable:true,value:function( ) {"use strict";
		...
		return (
			React.createElement("td", {id: ("cell-" + this.props.row + "-" + this.props.col), className: "cell", style: style, onClick: this.props.onSelect(("" + this.props.row + "-" + this.props.col))}, 
				this.props.cell.armies.map(function(army, idx)  
					{return React.createElement("div", {key: idx, className: "army", style: {color:army.owner}}, army.number);}
				)
			)
		)
	}});
